...
insert into orders (order_id, order_description, user_user_id) values( 2001, 'order11', 101);
insert into orders (order_id, order_description, user_user_id) values( 2002, 'order12', 101);
insert into orders (order_id, order_description, user_user_id) values( 2003, 'order13', 101);
insert into orders (order_id, order_description, user_user_id) values( 2004, 'order21', 102);
insert into orders (order_id, order_description, user_user_id) values( 2005, 'order22', 102);
insert into orders (order_id, order_description, user_user_id) values( 2006, 'order31', 103);